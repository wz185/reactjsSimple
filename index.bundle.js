...
/***/ function(module, exports, __webpack_require__) {
	...
	var _books = __webpack_require__(259);

	var _books2 = _interopRequireDefault(_books);

	var _active_book = __webpack_require__(260);

	var _active_book2 = _interopRequireDefault(_active_book);

	var _weather = __webpack_require__(261);
...
/***/ function(module, exports) {
	...
	exports.default = function () {
		return [{ title: 'Gone Girl' }, { title: 'The Martian' }, { title: 'React JS for dummy' }, { title: 'Angry Bird' }];
	};
...
/***/ function(module, exports) {
	...
	exports.default = function () {
		var state = arguments.length <= 0 || arguments[0] === undefined ? { title: 'Select a book to get started' } : arguments[0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _youtube_app = __webpack_require__(277);

	var _youtube_app2 = _interopRequireDefault(_youtube_app);

	var _app = __webpack_require__(283);

	var _app2 = _interopRequireDefault(_app);

	var _app3 = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/temperature/app\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	exports.default = _react2.default.createElement(
		_reactRouter.Route,
		{ path: '/', components: _app4.default },
		_react2.default.createElement(_reactRouter.Route, { path: 'temperature-app', components: _app4.default }),
		_react2.default.createElement(_reactRouter.Route, { path: 'youtube-app', components: _youtube_app2.default }),
		_react2.default.createElement(_reactRouter.Route, { path: 'books-app', components: _app2.default })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _youtubeApiSearch = __webpack_require__(278);

	var _youtubeApiSearch2 = _interopRequireDefault(_youtubeApiSearch);

	var _search_bar = __webpack_require__(279);

	var _search_bar2 = _interopRequireDefault(_search_bar);

	var _video_list = __webpack_require__(280);

	var _video_list2 = _interopRequireDefault(_video_list);

	var _video_detail = __webpack_require__(282);
	...
	var API_KEY = 'AIzaSyAI3eU72FLfynFfkyVKzR0s84oHKCHvT9Y';

	var YoutubeApp = function (_Component) {
		_inherits(YoutubeApp, _Component);

		function YoutubeApp(props) {
			_classCallCheck(this, YoutubeApp);

			var _this = _possibleConstructorReturn(this, (YoutubeApp.__proto__ || Object.getPrototypeOf(YoutubeApp)).call(this, props));
		...
		_createClass(YoutubeApp, [{
			...
			value: function render() {
				...
				var searchVideo = _.debounce(function (term) {
					_this3.searchVideo(term);
				}, 300);

				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_search_bar2.default, { onSearchVideo: function onSearchVideo(term) {
					...
					_react2.default.createElement(_video_list2.default, {
						onSelectVideo: function onSelectVideo(selectedVideo) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBar = function (_Component) {
		...
		function SearchBar(props) {
			...
			_this.state = { searchTerm: 'Search Here' };
			return _this;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _video_list_item = __webpack_require__(281);
		...
		_createClass(VideoList, [{
			...
			value: function render() {
				...
				var videoItems = this.props.videos.map(function (video) {
					return _react2.default.createElement(_video_list_item2.default, { onSelectVideo: _this2.props.onSelectVideo, key: video.etag, video: video });
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _book_list = __webpack_require__(284);

	var _book_list2 = _interopRequireDefault(_book_list);

	var _book_detail = __webpack_require__(286);
